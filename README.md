...
for better display, you can make a folder like "MyFilm.movie" with the following files: 

- title.json , with following { "title":"My Movie", "year":199X }
- video.mkv (or any file format its ok)
